...
## Получить доску.
## Получить кандидата.
## Взять из объекта координату.
## Проверить решаема ли задача с этим кандидатом с помощью валидатора Кирилла.
## 4.1. -- if true - Перезаписать доску и отдать ее в новый поиск ## новой координаты.
## 4.2 -- if false - Вернуть кандидата +1 в функцию поиска кандидата.
## Кол-во вызовов рекурсии не должно превышать 81
